          ...
          children: [
            ...
            Row(
              children: _categories.map((c) {
                ...
                switch (c) {
                  case 'urgent':
                    bg = isSelected ? AppColors.urgentLight : AppColors.surface;
                    text = isSelected
                        ? AppColors.urgent
                        : AppColors.textSecondary;
                    border = isSelected ? AppColors.urgent : AppColors.border;
                    break;
                  case 'academic':
                    bg = isSelected
                  ...
                  case 'exam':
                    ...
                    text = isSelected
                        ? AppColors.warning
                        : AppColors.textSecondary;
                    border = isSelected ? AppColors.warning : AppColors.border;
                    break;
                  default:
                    bg = isSelected ? AppColors.infoLight : AppColors.surface;
                    text = isSelected
                        ? AppColors.info
                        : AppColors.textSecondary;
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                hintText: 'e.g. Room change — Data Structures',
              ),
              maxLength: 100,
              validator: (v) =>
            ...
            ElevatedButton.icon(
              ...
              label: Text(
                _isPosting
                    ? 'Sending...'
                    : 'Send to ${_targetDept == 'ALL' ? 'all' : _targetDept} students',
              ),
              style: ElevatedButton.styleFrom(
                backgroundColor: _category == 'urgent' || _isUrgent
                    ? AppColors.urgent
                    : AppColors.primary,
